 ...
 * @Descripttion: 
 * @Author: 李增辉
 * @Date: 2022-04-13 09:46:43
 * @LastEditors: 李增辉
 * @LastEditTime: 2022-04-13 10:23:54
-->
...
export default {
  ...
  methods: {
    handleSizeChange(val) {
      ...
      this.$emit("getPagination", { page: this.currentPage, limit: val });
      if (this.autoScroll) {
        scrollTo(0, 800);
      }
    },
    handleCurrentChange(val) {
      ...
      this.$emit("getPagination", { page: val, limit: this.pageSize });
      if (this.autoScroll) {
        scrollTo(0, 800);
      }
    },
