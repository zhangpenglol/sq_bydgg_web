 ...
 * @LastEditors: 李增辉
 * @LastEditTime: 2022-04-26 18:01:07
-->
  ...
  <div>
    ...
    <div class="container-main">
      ...
      >
        ...
        <el-table-column property="address" label="地块总面积">
        </el-table-column>
        <el-table-column property="address" label="建新占用其他农用地面积">
        </el-table-column>
        <el-table-column property="address" label="建新占用未利用地面积">
        </el-table-column>
        <el-table-column property="name" label="建新占用建设用地面积">
        </el-table-column>
        <el-table-column property="name" label="建新占用耕地面积">
        </el-table-column>
        <el-table-column property="name" label="建新占用耕地等级">
        </el-table-column>
