 ...
 * @LastEditors: 李增辉
 * @LastEditTime: 2022-04-27 10:57:03
-->
  ...
  <div>
    ...
    <div class="container-main">
      ...
      >
        ...
        <el-table-column property="date" label="所属区县"> </el-table-column>
        <el-table-column property="name" label="项目区编号"> </el-table-column>
        <el-table-column property="address" label="实施方案项目区名称">
        </el-table-column>
        <el-table-column property="address" label="项目状态"> </el-table-column>
        <el-table-column property="address" label="实施方案批文号">
        </el-table-column>
        <el-table-column property="address" label="批复日期"> </el-table-column>
        <el-table-column property="address" label="报批用地类型">
        </el-table-column>
        <el-table-column property="address" label="挂钩指标类型">
        </el-table-column>
        <el-table-column property="address" label="地块总面积（公顷）">
        </el-table-column>
